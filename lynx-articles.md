...
- [How I Turned My Company’s Docs into a Searchable Database with OpenAI | by Jacob Marks, Ph.D. | Towards Data Science](https://towardsdatascience.com/how-i-turned-my-companys-docs-into-a-searchable-database-with-openai-4f2d34bd8736)
...
- [Constructing knowledge graphs from text using OpenAI functions | by Tomaz Bratanic | Medium](https://bratanic-tomaz.medium.com/constructing-knowledge-graphs-from-text-using-openai-functions-096a6d010c17)
...
- [No-code in the front, Python in the back. Data apps with Streamsync. | Better Programming](https://betterprogramming.pub/streamsync-like-streamlit-but-faster-and-with-a-visual-ui-editor-9f98ad17adf)
...
- [Learn Rust - Rust Programming Language](https://doc.rust-lang.org/)
...
- [Implement the MITRE ATT&CK Framework in 2024 | by Ibrahim Akdağ| Ph.D. | Medium](https://ibrahimakkdag.medium.com/5-ways-to-apply-the-mitre-att-ck-framework-6b17820cb675)
- [Analyzing and visualizing cyberattacks using Attack Flow | by Lennart Erikson | System Weakness](https://systemweakness.com/analyzing-and-visualizing-cyberattacks-using-attack-flow-4ccad73c1e8a)
...
- [Implement the MITRE ATT&CK Framework in 2024 | by Ibrahim Akdağ| Ph.D. | Medium](https://ibrahimakkdag.medium.com/5-ways-to-apply-the-mitre-att-ck-framework-6b17820cb675)
- [Deep Dive: How are the Top ATT&CK Techniques calculated and why should you care? | by Lennart Erikson | Medium](https://medium.com/@lerikson/deep-dive-how-are-the-top-att-ck-techniques-calculated-and-why-should-you-care-39ba3d19bcdd)
- [How I use the MITRE D3FEND Matrix to defend against ATT&CK(s) | by Lennart Erikson | Medium](https://medium.com/@lerikson/how-i-use-the-mitre-d3fend-matrix-to-defend-against-att-ck-s-9f98cb23df60)
- [Using LLMs to improve your Incident Response capability: AttackGen 👾 | by Lennart Erikson | Medium](https://medium.com/@lerikson/using-llms-to-improve-your-incident-response-capability-attackgen-1db851d0083b)
- [Analyzing and visualizing cyberattacks using Attack Flow | by Lennart Erikson | System Weakness](https://systemweakness.com/analyzing-and-visualizing-cyberattacks-using-attack-flow-4ccad73c1e8a)
...
- [GitHub - center-for-threat-informed-defense/tram: TRAM is an open-source platform designed to advance research into automating the mapping of cyber threat intelligence reports to MITRE ATT&CK®.](https://github.com/center-for-threat-informed-defense/tram)
- [https://mad.mitre-engenuity.org/Roadmap/THDE](https://mad.mitre-engenuity.org/Roadmap/THDE)
- [Welcome to the 2023 Threat Report Compilation! | 2023-Threat-Report-Compilation](https://jwennekers.github.io/2023-Threat-Report-Compilation/)
- [Our TRAM Large Language Model Automates TTP Identification in CTI Reports | by Jon Baker | MITRE-Engenuity | Medium](https://medium.com/mitre-engenuity/our-tram-large-language-model-automates-ttp-identification-in-cti-reports-5bc0a30d4567)
- [Threat Hunting — Hafinum APT. Let’s hunt APT threats!!!!!! | by whoami | Medium](https://medium.com/@wenray/threat-hunting-hafinum-apt-15fe38846808)
- [Strengthening the Connection: VERIS and MITRE ATT&CK® | by Ingrid Skoog | MITRE-Engenuity | Medium](https://medium.com/mitre-engenuity/strengthening-the-connection-veris-and-mitre-att-ck-c3aac3fa9cd7)
- [What Is Cyber Threat Intelligence? | by Packt | Medium](https://packt.medium.com/what-is-cyber-threat-intelligence-7f369e5d773b)
- [Threat Intelligence with MISP: Part 1 — What is MISP? | by Adam Goss | Medium](https://adamgoss.medium.com/cyber-threat-intelligence-with-misp-part-1-what-is-misp-d2eaba66336a)
- [Using FOCA for OSINT Document Metadata Analysis | by wondersmith_rae | Medium](https://wondersmithrae.medium.com/using-foca-for-osint-document-metadata-analysis-6745c8d709fa)
- [Threat Intelligence with MISP: Part 2 — Setting up MISP | by Adam Goss | InfoSec Write-ups](https://infosecwriteups.com/threat-intelligence-with-misp-part-2-setting-up-misp-be857bba8e7)
- [The Three Types of Intelligence for Threat Intelligence: A Comprehensive Guide | by VEEXH | The Sleuth Sheet | Medium](https://medium.com/the-sleuth-sheet/the-three-types-of-intelligence-for-threat-intelligence-a-comprehensive-guide-e8bbf1f26164)
- [Free Cyber Threat Feeds. Cyber threat feeds (or threat data… | by Chad Warner | Medium](https://warnerchad.medium.com/free-cyber-threat-feeds-3a7e8c6159c2)
- [Creating Your Own CTI Aggregator for Free: A Complete Guide | by Adam Goss | InfoSec Write-ups](https://adamgoss.medium.com/creating-your-own-cti-aggregator-for-free-a-complete-guide-b350bfea754a)
- [Netlas](https://app.netlas.io/)
- [How to detect scam and shadow IT domains with Netlas.io? | by Netlas.io | OSINT Ambition](https://publication.osintambition.org/how-to-detect-scam-and-shadow-it-domains-with-netlas-io-f72085e6f18b)
...
- [https://mayfly277.github.io/assets/blog/pentest_ad_dark.svg](https://mayfly277.github.io/assets/blog/pentest_ad_dark.svg)
- [GitHub - Orange-Cyberdefense/arsenal: Arsenal is just a quick inventory and launcher for hacking programs](https://github.com/Orange-Cyberdefense/arsenal/)
...
- [KYC — Know your Container(image) with SLSA, SBOM and Binary Authorization | by Daniel Strebel | Google Cloud - Community | Medium](https://medium.com/google-cloud/kyc-know-your-container-image-with-slsa-sbom-and-binary-authorization-8bad35d9cbd0)
- [Kubernetes namespaces isolation - what it is, what it isn't, life,](https://www.synacktiv.com/publications/kubernetes-namespaces-isolation-what-it-is-what-it-isnt-life-universe-and-everything)
- [Introduction to Kubernetes Security | Medium | ITNEXT](https://itnext.io/introduction-to-kubernetes-security-for-security-professionals-a61b424f7a2a)
...
- [About Detection Engineering. In recent months I’ve noticed several… | by Florian Roth | Medium](https://cyb3rops.medium.com/about-detection-engineering-44d39e0755f0)
...
- [Measuring Detection Volatility. Series: Measuring the effectiveness of… | by Gary Katz | Medium](https://medium.com/@gary.j.katz/measuring-detection-volatility-f2a2d51fdaa6)
- [Linux auditd for Threat Detection [Final] | by IzyKnows](https://izyknows.medium.com/linux-auditd-for-threat-detection-final-9d5173706b3f)
...
- [Detection Engineering Metrics Building Blocks | by Gary Katz | Medium](https://medium.com/@gary.j.katz/detection-engineering-metrics-building-blocks-97be4bccf27b)
- [Network Forensics & Malware Analysis— HawkEye | by whoami | System Weakness](https://systemweakness.com/malware-analysis-network-forensics-hawkeye-91043e39baea)
- [About Detection Engineering. In recent months I’ve noticed several… | by Florian Roth | Medium](https://cyb3rops.medium.com/about-detection-engineering-44d39e0755f0)
- [Uncovering The Unknowns. Mapping Windows API’s to Sysmon Events | by Jonathan Johnson | Posts By SpecterOps Team Members](https://posts.specterops.io/uncovering-the-unknowns-a47c93bb6971)
- [Fast-Tracking Incident Detection with User and Entity Behavior Analytics (UEBA) | by Renae Kang | Adobe Tech Blog](https://blog.developer.adobe.com/fast-tracking-incident-detection-with-user-and-entity-behavior-analytics-ueba-733d2b17263d)
- [Evadere Classifications. Introduction | by Jonathan Johnson | Posts By SpecterOps Team Members](https://posts.specterops.io/evadere-classifications-8851a429c94b)
- [What's missing before the 'One Metric That Matters' in Threat Detection? | by Alex Teixeira | Detect FYI](https://detect.fyi/whats-missing-before-the-one-metric-that-matters-in-threat-detection-f988bcde80d1)
- [https://specterops.io/wp-content/uploads/sites/3/2022/06/RPC_for_Detection_Engineers.pdf](https://specterops.io/wp-content/uploads/sites/3/2022/06/RPC_for_Detection_Engineers.pdf)
- [The dark side of Microsoft Remote Procedure Call protocols | by Jonathan Johnson | Medium](https://jsecurity101.medium.com/the-dark-side-of-microsoft-remote-procedure-call-protocols-9ad5cb2d2b12)
- [An Object-Oriented Approach to Threat Detection Engineering | by Brendan Chamberlain | Detect FYI](https://detect.fyi/an-object-oriented-approach-to-threat-detection-engineering-6eadab7e2227)
- [Detection Engineering is Painful — and It Shouldn’t Be (Part 1) | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/detection-engineering-is-painful-and-it-shouldnt-be-part-1-3641d8740458)
- [Detecting NTLM Relay Attacks. It is possible to detect NTLM relaying… | by Mehmet Ergene | Blu Raven | Medium](https://posts.bluraven.io/detecting-ntlm-relay-attacks-d92e99e68fb9)
- [Introducing Query Post-Processing and Output Finalization to Processing Pipelines | by Thomas Patzke | Sigma_HQ](https://medium.com/sigma-hq/introducing-query-post-processing-and-output-finalization-to-processing-pipelines-4bfe74087ac1)
- [Better know a data source: Access tokens (and why they’re hard to get) | by Jonathan Johnson | Medium](https://jsecurity101.medium.com/better-know-a-data-source-access-tokens-and-why-theyre-hard-to-get-7bc951eae0b9)
- [Detection Engineering and SOC Scalability Challenges (Part 2) | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/detection-engineering-and-soc-scalability-challenges-part-2-6d2cf83a8467)
- [The thin line between an event and an incident. | Tales from a Security Professional](https://tales-from-a-security-professional.com/the-thin-line-between-an-event-and-an-incident-e93032c9eba7)
- [Measuring Detection Volatility. Series: Measuring the effectiveness of… | by Gary Katz | Medium](https://medium.com/@gary.j.katz/measuring-detection-volatility-f2a2d51fdaa6)
- [Threat hunting Pivoting via SMB Named Pipe | by Tho Le | Medium](https://tho-le.medium.com/threat-hunting-pivoting-via-smb-named-pipe-44f5f9b45b7b)
- [Overview — Summiting the Pyramid v1.0.0 documentation](https://center-for-threat-informed-defense.github.io/summiting-the-pyramid/overview/)
- [50 Threat Hunting Hypothesis Examples | by Cyborg Security | Medium](https://cyborgsecurity.medium.com/50-threat-hunting-hypothesis-examples-87db655d737f)
- [Abstraction Maps](https://abstractionmaps.com)
- [Summiting the Pyramid — A new Dimension of “Cyber Analytics Engineering” | by Simone Kraus | Detect FYI](https://medium.com/@simone.kraus/summiting-the-pyramid-a-new-dimension-of-cyber-analytics-engineering-81d2319a34e0)
- [https://www.betaalvereniging.nl/wp-content/uploads/TaHiTI-Threat-Hunting-Methodology-whitepaper.pdf](https://www.betaalvereniging.nl/wp-content/uploads/TaHiTI-Threat-Hunting-Methodology-whitepaper.pdf)
- [Open Season: Guide to Building a Threat Hunting Workflow Pt.1 | by Cryptic_Glyd3r | Medium](https://medium.com/@cryptic_glyd3r/open-season-guide-to-setting-up-the-workflow-for-your-hunting-team-pt-1-67cbb9542045)
- [Rethinking Detection Engineering – Jared Atkinson (SO-CON 2020)](https://www.youtube.com/watch?v=CRtmeWCbRZQ)
- [Left of SIEM? Right of SIEM? Get It Right! | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/left-of-siem-right-of-siem-get-it-right-4b07c54cf062)
- [Summiting the Pyramid: Level Up Your Cyber Analytics | MITRE-Engenuity](https://medium.com/mitre-engenuity/summiting-the-pyramid-level-up-your-analytics-b6f12efd9133)
- [https://medium.com/@peritomadruga/threat-hunting-vs-incident-response-whats-the-difference-a3e21c78899c](https://medium.com/@peritomadruga/threat-hunting-vs-incident-response-whats-the-difference-a3e21c78899c)
- [The dotted lines between Threat Hunting and Detection Engineering | by Alex Teixeira | Detect FYI](https://detect.fyi/the-dotted-lines-between-threat-hunting-and-detection-engineering-94fa0f7f62ce)
- [Anton and The Great XDR Debate, Part 1 | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/anton-and-the-great-xdr-debate-part-1-8ed148c3cee4)
- [Detect DLL Hijacking techniques from HijackLibs with Splunk | by mthcht | Detect FYI](https://detect.fyi/detect-dll-hijacking-techniques-from-hijacklibs-with-splunk-c760d2e0656f)
- [Detecting and responding to ESXi compromise with Splunk | by Alex John | Detect FYI](https://detect.fyi/detecting-and-responding-to-esxi-compromise-with-splunk-f33998ce7823)
- [Chronicle Detect is Here. A lot of people ask me how Chronicle is… | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/chronicle-detect-is-here-63a779679e56)
- [Windows RDP Session Hijacking. How Red Team members take control over… | by c0d3x27 | InfoSec Write-ups](https://infosecwriteups.com/windows-rdp-session-hijacking-e7b2bbf1356b)
- [Exploring Token Members Part 1. LogonSessions | by Jonathan Johnson | Medium](https://jsecurity101.medium.com/exploring-token-members-part-1-48bce8004c6a)
- [Demystifying DLL Hijacking Understanding the Intricate World of Dynamic Link Library Attacks | by Jonathan Johnson | Medium](https://jsecurity101.medium.com/demystifying-dll-hijacking-understanding-the-intricate-world-of-dynamic-link-library-attacks-7a952ac8b051)
- [https://redcanary.com/blog/detection-validation/](https://redcanary.com/blog/detection-validation/)
- [Detecting Threats by Matching Threat Intel to Logs — Oh Really? | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/detecting-threats-by-matching-threat-intel-to-logs-oh-really-10cc8a4c6384)
- [You Can Run, But You Can’t Hide — Detecting Process Reimaging Behavior | by Jonathan Johnson | Posts By SpecterOps Team Members](https://posts.specterops.io/you-can-run-but-you-cant-hide-detecting-process-reimaging-behavior-e6bb9a10c40b)
- [Understanding the New SaaS Cyber Kill Chain - YouTube](https://www.youtube.com/watch?v=cJKtREGhjE8)
- [Detecting network beacons via KQL using simple spread stats functions | by Alex Teixeira | Detect FYI](https://detect.fyi/detecting-network-beacons-via-kql-using-simple-spread-stats-functions-c2f031b0736b)
- [Focus Threat Intel Capabilities at Detection Engineering (Part 4) | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/aim-the-intel-function-on-detection-engineering-part-4-5ad8137560bf)
- [Finding Forensic Goodness In Obscure Windows Event Logs | by Nasreddine Bencherchali | Medium](https://nasbench.medium.com/finding-forensic-goodness-in-obscure-windows-event-logs-60e978ea45a3)
- [DIY: In-house Threat Detection Engineering | by Alex Teixeira | Medium](https://ateixei.medium.com/diy-in-house-threat-detection-engineering-73643a0b06f)
- [A Dive Into Web Application Authentication | by James Chiappetta | better appsec](https://betterappsec.com/a-medium-dive-into-web-application-authentication-342d1d002a61)
...
## Blog Posts
### OrbitLink
- [Hack Satellites: Part 3. Use a digital twin like instruction set… | by David Merian | System Weakness](https://systemweakness.com/hack-satellites-part-3-8929699ecb3)
- [Intel® Simics® Simulator](https://www.intel.com/content/www/us/en/developer/articles/tool/simics-simulator.html)
...
- [OpenSCADA: Main](http://oscada.org/)
- [SCADA SIMULATOR](http://www.scadasoftware.net/scada/scadasimulator.html)
- [GitHub - cmu-sei/SCADASim: The SCADA Simulator is a configurable system that presents itself as a SCADA system within an exercise environment. It has a web-accessible user interface and generates modbus traffic on the network.](https://github.com/cmu-sei/SCADASim)

#### OCO
- [Autonomy – Open-source PLC Software](https://openplcproject.com/) (PLC's)
- [Rapid SCADA | Free, Open Source,  Full Featured SCADA Software](https://rapidscada.org/) (HMI)

#### DCO
- [Installing ScadaBR |  OpenPLCProject](https://openplcproject.gitlab.io/reference/scada/installing-scadabr.html) (HMI)
- [Autonomy – Open-source PLC Software](https://openplcproject.com/) (PLC's)

### NetMap
- [D3Blocks: The Python Library to Create Interactive and Standalone D3js Charts. | by Erdogan Taskesen | Towards Data Science](https://towardsdatascience.com/d3blocks-the-python-library-to-create-interactive-and-standalone-d3js-charts-3dda98ce97d4)
- [The New Best Python Package for Visualising Network Graphs | by Benjamin Lee | Towards Data Science](https://towardsdatascience.com/the-new-best-python-package-for-visualising-network-graphs-e220d59e054e)

### Spectrum Analyzer
- [Mastering Plotly: Let your Visualizations Talk Through Plotly | by RaviTeja G | DataDrivenInvestor](https://medium.datadriveninvestor.com/mastering-plotly-let-your-visualizations-talk-through-plotly-492d6e277ca4)

### Web PTT/ WIC Trials
- [GitHub - cmu-sei/foundry-appliance: A virtual appliance for building cyber labs, challenges and competitions](https://github.com/cmu-sei/foundry-appliance)
- [GitHub - cmu-sei/crucible: Crucible is a modular framework for creating, deploying, and managing virtual environments to support training, education, and exercises.](https://github.com/cmu-sei/crucible)
- [GitHub - cmu-sei/CDAS: This program generates cyber attack scenarios for use in cyber training exercises, red team planning, blue team planning, automated attack execution, and cybersecurity policy analysis.](https://github.com/cmu-sei/CDAS)
- [Python: 3 Sqlalchemy useful tips you will use almost every time | ITNEXT](https://itnext.io/pythons-sqlalchemy-3-powerful-features-you-need-to-know-433a8af565ec)
- [https://medium.com/@ramiromedina/like-streamlit-but-fast-enabling-low-latency-data-apps-948b95b098a2](https://medium.com/@ramiromedina/like-streamlit-but-fast-enabling-low-latency-data-apps-948b95b098a2)

### DST Updates
- [Digital Forensics — CyberCorp Case 1 | by whoami | Medium](https://medium.com/@wenray/digital-forensics-cybercorp-case-1-75867b95bc88)
- [Investigating Memory Forensic -Processes, DLLs, Consoles, Process Memory and Networking | by Alp Batur | Medium](https://alpbatursahin.medium.com/investigating-memory-forensic-processes-dlls-consoles-process-memory-and-networking-7277689a09b7)
...
- [GitHub - cmu-sei/GHOSTS: GHOSTS is a realistic user simulation framework for cyber simulation, training, and exercise](https://github.com/cmu-sei/GHOSTS)
- [GitHub - cmu-sei/GHOSTS: Animator](https://github.com/cmu-sei/GHOSTS-ANIMATOR)
- [GitHub - cmu-sei/GHOSTS: Spectre](https://github.com/cmu-sei/GHOSTS-SPECTRE)
- [GitHub - cmu-sei/ghosts-cyber-range-and-exercise-simulation-tools: Range and simulation tools for executing realistic training and exercise events](https://github.com/cmu-sei/ghosts-cyber-range-and-exercise-simulation-tools)
- [GitHub - cmu-sei/SEER: SEER is a platform for assessing the performance of cybersecurity training and exercise participants.](https://github.com/cmu-sei/SEER)
- [GitHub - cmu-sei/greybox: A tool to host an Internet simulation](https://github.com/cmu-sei/greybox)
- [GitHub - cmu-sei/Stormbox: Stormbox is an "internet user simulator" that is designed to simulate the transient, temporary, and anonymous nature of typical internet users during a cyber wargame.](https://github.com/cmu-sei/Stormbox)
- [GitHub - cmu-sei/finsim: FinSim is a financial simulation tool for exercise environments. It provides students the opportunity to investigate a model financial system and its associated security concerns.](https://github.com/cmu-sei/finsim)
- [GitHub - cmu-sei/usersim: An agent that performs user actions on a workstation](https://github.com/cmu-sei/usersim)

### Orbitlink
- [An Introduction to Asynchronous Programming in Python 3 | by Samuel Cook | Better Programming](https://betterprogramming.pub/an-intro-to-asynchronous-programming-in-python-3-7cfa9173234)
...
- [Using Obsidian for Work. Lots of people use Obsidian for their… | by Ensley Tan | Medium](https://medium.com/@ensleytan/using-obsidian-for-work-5192e95314a0)
- [My Step by Step Process to Create a Permanent Note in Zettelkasten | by Brooke Harrison | Medium](https://brookewrites.medium.com/my-step-by-step-process-to-create-a-permanent-note-in-zettelkasten-a4fd356ec636)
...
- [Can We Have “Detection as Code”?. One more idea that has been bugging me… | by Anton Chuvakin | Anton on Security | Medium](https://medium.com/anton-on-security/can-we-have-detection-as-code-96f869cfdc79)
- [Sensor Mapping — Sensor Mappings to ATT&CK v1.0.0 documentation](https://center-for-threat-informed-defense.github.io/sensor-mappings-to-attack/levels/)
...
- [Incident Response Tool — Chainsaw | by whoami | System Weakness](https://systemweakness.com/incident-response-tool-chainsaw-ed1fc5775344)
- [Understanding & Detecting C2 Frameworks — BabyShark | by Nasreddine Bencherchali | Medium](https://nasbench.medium.com/understanding-detecting-c2-frameworks-babyshark-641be4595845)
- [Sliver C2 Implant Analysis. Sliver C2 Implant Analysis | by Michael Koczwara | Medium](https://michaelkoczwara.medium.com/sliver-c2-implant-analysis-62773928097f)
...
- [Document naming conventions](https://records.unimelb.edu.au/guides/naming-conventions)
- [System Design Cheatsheets: ElasticSearch | by Sanil Khurana | Towards Data Science](https://towardsdatascience.com/system-design-cheatsheets-elasticsearch-673b98eebfff)
- [Six Books that Have Shaped My Data Career | by Chad Isenberg | Towards Data Science](https://towardsdatascience.com/six-books-that-have-shaped-my-data-career-8d9db9a40691)


## .NET/ Custom Logs
- [A Simple Event Sourcing Implementation in .NET | by Matt Bentley | Level Up Coding](https://levelup.gitconnected.com/a-simple-event-sourcing-implementation-in-net-b53c40401ecb)
- [Event-o-Pedia EventID 7035 - The %1 service was successfully sent a %2 control.](http://eventopedia.cloudapp.net/EventDetails.aspx?id=20130ab0-cad5-43df-8636-8e607f167c4e)
...
- [Homelab learning: A general overview of my homelab hardware and topology | by Evyn Hedgpeth | Medium](https://medium.com/@emhedge/homelab-learning-a-general-overview-of-my-homelab-hardware-and-topology-d4ef3a7336b1)
- [Homelab learning: Configuring Proxmox VE to host your cybersecurity homelab | by Evyn Hedgpeth | Medium](https://medium.com/@emhedge/homelab-learning-configuring-proxmox-ve-to-host-your-cybersecurity-homelab-fda24dcb04cc)
- [Mordor Labs 😈 — Part 3: Executing ATT&CK APT29 Evaluations Emulation Plan 📕 -Day2 | by Roberto Rodriguez | Open Threat Research | Medium](https://medium.com/threat-hunters-forge/mordor-labs-part-3-executing-att-ck-apt29-evaluations-emulation-plan-day2-417cadc2a337)
- [Purple Team | Caldera & Wazuh | Medium](https://enescayvarli.medium.com/purple-team-caldera-wazuh-b5dd38971e65)
- [Part 2. Graylog Install — Log Ingestion | by SOCFortress | Medium](https://socfortress.medium.com/part-2-graylog-install-log-ingestion-f26140790fab)
- [A Simple Elastic SIEM Lab. In this guide, I’ll walk you through… | by Abdullahi Ali | Medium](https://medium.com/@aali23/a-simple-elastic-siem-lab-6765159ee2b2)
- [Build Your Own SIEM Stack with Open Source Tools Series | by SOCFortress | Medium](https://socfortress.medium.com/build-your-own-siem-stack-with-open-source-tools-series-39da0f2d412a)
- [GitHub - OTRF/SimuLand: Cloud Templates and scripts to deploy mordor environments](https://github.com/OTRF/SimuLand)
- [Redis: The Complete Developer's Guide | Udemy](https://www.udemy.com/course/redis-the-complete-developers-guide-p/)
- [How I turned a cheap weather station (and a whole lot of things I already own) into a personal DevOps-style weather dashboard | by Brian R. Jackson | Medium](https://medium.com/@jaxzin/how-i-turned-a-cheap-weather-station-into-a-personal-devops-dashboard-5c8820790fd5)
- [Building Blue Team Home Lab Part 1 - Introduction | facyber](https://facyber.me/posts/blue-team-lab-guide-part-1/)
- [Kubernetes multi-cluster implementation in under 10 minutes | by Akriotis Kyriakos | ITNEXT](https://itnext.io/kubernetes-multi-cluster-implementation-in-under-10-minutes-2927952fb84c)
- [The 23 Best Things to Build with a Raspberry Pi | by Esteban Thilliez | Medium](https://medium.com/@estebanthi/the-23-best-things-to-build-with-a-raspberry-pi-9cbc40169997)
- [Install a Real-Time Intrusion Detection System (IDS) with Suricata and Python | by Rubens Zimbres | Medium](https://medium.com/@rubenszimbres/install-a-real-time-intrusion-detection-system-ids-with-suricata-and-python-7ce7ae78c5a3)
